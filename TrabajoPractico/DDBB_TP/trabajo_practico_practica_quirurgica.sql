...
--
-- Table structure for table `practica_quirurgica`
--

DROP TABLE IF EXISTS `practica_quirurgica`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `practica_quirurgica` (
...
--
-- Dumping data for table `practica_quirurgica`
--
...
-- Dump completed on 2023-06-30 19:15:51
