...
--
-- Table structure for table `practica_diagnostica`
--

DROP TABLE IF EXISTS `practica_diagnostica`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `practica_diagnostica` (
  `id_tratamiento` int NOT NULL,
  `confirmacion_dpresuntivo` tinyint(1) DEFAULT '0',
...
--
-- Dumping data for table `practica_diagnostica`
--
