...
CREATE TABLE `rango_etario` (
  `id_rango_etario` tinyint NOT NULL AUTO_INCREMENT,
...
LOCK TABLES `rango_etario` WRITE;
/*!40000 ALTER TABLE `rango_etario` DISABLE KEYS */;
INSERT INTO `rango_etario` VALUES (1,'Recien nacida'),(2,'Primera infancia'),(3,'Infante'),(4,'Adolescente'),(5,'Joven'),(6,'Adulta'),(7,'Adulta mayor'),(8,'Adulta mayor 2'),(9,'Vieja'),(10,'Anciana');
/*!40000 ALTER TABLE `rango_etario` ENABLE KEYS */;
UNLOCK TABLES;
