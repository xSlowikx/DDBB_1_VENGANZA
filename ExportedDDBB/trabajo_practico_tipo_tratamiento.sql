...
CREATE TABLE `tipo_tratamiento` (
  `id_tipo_tratamiento` tinyint NOT NULL AUTO_INCREMENT,
  `descripcion` varchar(50) DEFAULT NULL,
  `id_tipo_procedimiento` tinyint NOT NULL,
  PRIMARY KEY (`id_tipo_tratamiento`),
  KEY `fk_id_tipo_procedimiento` (`id_tipo_procedimiento`),
...
INSERT INTO `tipo_tratamiento` VALUES (1,'Diagnostico',1),(2,'Diagnostico',2),(3,'Prescriptivo',1),(4,'Prescriptivo',2),(5,'Curativo',1),(6,'Curativo',2);
